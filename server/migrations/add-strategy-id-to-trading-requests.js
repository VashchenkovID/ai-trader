...
async function addStrategyIdToTradingRequests() {
    try {
        console.log('🔄 Adding strategyId column to trading_requests table...');
        ...
        await sequelize.query(`
            ...
            BEGIN
                IF NOT EXISTS (
                    ...
                    WHERE conname = 'trading_requests_strategyId_fkey'
                ) THEN
                    ALTER TABLE "trading_requests"
                    ADD CONSTRAINT "trading_requests_strategyId_fkey"
        ...
        await sequelize.query(`
            CREATE INDEX IF NOT EXISTS "idx_trading_requests_strategy_id" 
            ON "trading_requests"("strategyId");
        `);
...
// Запускаем миграцию
addStrategyIdToTradingRequests();
