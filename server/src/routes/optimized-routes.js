...
import autoPaperTradingRoutes from './auto-paper-trading-routes.js';
...
import portfolioOptimizerRoutes from './portfolio-optimizer-routes.js';
...
import workerMonitoringRoutes from './worker-monitoring-routes.js';
import weeklyForecastRoutes from './weekly-forecast-routes.js';
...
router.use('/workers', workerMonitoringRoutes);
router.use('/weekly-forecast', weeklyForecastRoutes);
...
router.use('/auto-paper-trading', autoPaperTradingRoutes);
...
router.use('/portfolio-optimizer', portfolioOptimizerRoutes);
