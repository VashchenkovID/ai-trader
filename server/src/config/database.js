...
const sequelize = new Sequelize(
    ...
    passwordString,
    {
        ...
        pool: {
            max: 15, // Оптимизировано для низкой нагрузки: достаточно для воркеров + небольшой запас
            min: 2, // Уменьшено для экономии ресурсов при низкой нагрузке
            acquire: 60000, // Максимальное время ожидания получения соединения (60 секунд)
            idle: 300000, // Максимальное время простоя соединения перед закрытием (5 минут)
            evict: 5000, // Интервал проверки неактивных соединений (5 секунд)
