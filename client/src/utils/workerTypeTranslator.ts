...
const workerTypeTranslations: { [key: string]: string } = {
  ...
  'partial-exit-check': 'Проверка частичного закрытия',
  'position-monitoring': 'Мониторинг позиций',
  'degradation-check': 'Проверка деградации моделей',
  'predictions-update': 'Обновление предсказаний',
  'signals-update': 'Обновление сигналов аналитиков',
  'trailing-stops-check': 'Проверка трейлинг-стопов',
  'portfolio-rebalancing': 'Ребалансировка портфеля',
  'cleanup': 'Очистка старых свечей',
  'trading-hours-check': 'Обновление торговых часов',
  'trading-hours-cache-update': 'Обновление кеша торговых часов',
  'daily-report': 'Ежедневный отчет',
  'data-cleanup': 'Автоматическая очистка данных',
  'strategy-rebalance': 'Перебалансировка стратегий',
  'correlation-precalc': 'Предрасчет корреляций',
