    ...
    <>
      ...
      {loading ? (
              ...
              >
                <div className="flex flex-column gap-2">
                    ...
                    <div className="flex align-items-center gap-2 flex-1">
                      ...
                      <div className="flex-1">
                        <div className="flex align-items-center gap-2">
                          <span className="text-sm font-medium number-text-primary">{indicator.label}</span>
                        </div>
                        {data?.source && (
                  ...
                  {(forecast !== undefined || previousValue !== undefined) && (
                    <div className="flex align-items-center gap-3 pt-1 border-top-1 border-200">
                      {previousValue !== undefined && previousValue !== null && (
                        <div className="flex align-items-center gap-1">
                          <small className="text-xs text-500">Предыдущее:</small>
                      ...
                      {forecast !== undefined && forecast !== null && (
                        <div className="flex align-items-center gap-1">
                          <small className="text-xs text-500">Прогноз:</small>
                          <small className="text-xs font-medium text-blue-500">
        ...
        <div className="flex align-items-center justify-content-center p-4">
          <p className="text-sm text-500">Нет данных. Нажмите кнопку обновления для загрузки макро-данных.</p>
        </div>
      )}
      </Card>
    </>
